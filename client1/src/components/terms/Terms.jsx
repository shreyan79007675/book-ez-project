...
const Terms =()=>{
    ...
    return(
        <div>
            ...
            <hr/>
            <p>These Terms of Service reflect the way that Book-Ez business works, the laws that apply to our company, and certain things that we’ve always believed to be true. As a result, these Terms of Service help define Book-Ez relationship with you as you interact with our services.</p>
            ...
            <li class="H2">Content in Book-Ez services, which describes the intellectual property rights to the content that you find in our services – whether that content belongs to you, Book-Ez or others</li>
            ...
            <hr/>
            <p>Book-Ez services are provided by, and you’re contracting with:</p>
            <br/>
            <p>Book-Ez LLC</p>
